...
All platforms: [![Circle CI](https://circleci.com/gh/conda-forge/contact_map-feedstock.svg?style=shield)](https://circleci.com/gh/conda-forge/contact_map-feedstock)

Current release info
====================
Version: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/contact_map/badges/version.svg)](https://anaconda.org/conda-forge/contact_map)
Downloads: [![Anaconda-Server Badge](https://anaconda.org/conda-forge/contact_map/badges/downloads.svg)](https://anaconda.org/conda-forge/contact_map)
...
Once the `conda-forge` channel has been enabled, `contact_map` can be installed with:

```
conda install contact_map
```

It is possible to list all of the versions of `contact_map` available on your platform with:
